                ...
                <div className="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:justify-end sm:mt-0 sm:ps-5">
                    ...
                    <div className="relative">
                        ...
                        <div
                            ...
                            } absolute mt-2 bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 z-10`}
                        >
                            {/* Dropdown items */}
                            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" href="#">Whole House Systems</a>
                            <a className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700" href="#">Drinking Water Systems</a>
                        </div>
                    </div>
                    <a className="font-medium text-gray-600 hover:text-gray-400 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Contams</a>
                </div>
            </div>
        </nav>
    </React.Fragment>
