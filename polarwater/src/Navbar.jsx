...
function Navbar() {
  ...
  return (
    <React.Fragment>
      <div className="relative flex flex-wrap sm:justify-between sm:flex-nowrap z-50 w-full text-sm py-3 blueOne">
        <nav
        ...
        >
          ...
          <div className="hidden sm:flex sm:items-center w-full me-20 justify-center">
