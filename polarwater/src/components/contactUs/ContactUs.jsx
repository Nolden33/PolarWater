...
function ContactUs() {
    ...
    useEffect(() => {
        // Get the accordionId from URL parameters
        const accordionId = searchParams.get("accordionId");
        if (accordionId) {
            setActiveId(parseInt(accordionId, 10)); // Set activeId from URL parameter
        }
    }, [searchParams]);
        ...
        },
        {
            ...
            content: (
                <div className="text-lg text-left">
                    ...
                    <ul className="list-none md:list-disc list-inside mt-4">
                        <li>First Responders</li>
                        <li>Active Military and Veterans</li>
            ...
            content: (
                <div className="text-2xl text-left font-bold">
                    ...
                    <div className="text-xl text-left font-normal mt-4">
                        How It Works: Refer a friend or family member to Polar Water, and when they make a purchase, both of you receive $100.
                    </div>
                    <ul className="list-none md:list-disc list-inside text-lg text-left font-normal mt-4">
                        <li>
                        ...
                        <li>No Limits: The more referrals you make, the more you earn!</li>
                        <li>
