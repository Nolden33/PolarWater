...
function ContamSection() {
    const contams = [
        { title: "Lead", description: "Description of card 1.", image: Lead },
        { title: "Flouride", description: "Description of card 2.", image: Flouride },
        { title: "Arsenic", description: "Description of card 3.", image: Arsenic },
        { title: "Pesticides", description: "Description of card 4.", image: Pesticides },
        { title: "Pharmaceuticals", description: "Description of card 5.", image: Pharmaceuticals },
        { title: "Chlorine", description: "Description of card 6.", image: Chlorine }
    ];
