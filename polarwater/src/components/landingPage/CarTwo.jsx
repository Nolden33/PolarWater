        ...
        <React.Fragment>
            {/* <!-- Hero --> */}
                ...
                <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-10">
                    ...
                    {/* <!-- End Announcement Banner --> */}<br />

                    {/* <!-- Title --> */}
                    <div className="mt-5 max-w-2xl text-center mx-auto">
                    <h1 className="block font-bold text-gray-800 text-4xl md:text-5xl lg:text-6xl dark:text-gray-200">
                        Pay me what you <br />
                        <span className="bg-clip-text bg-gradient-to-tl from-blue-600 to-violet-600 text-transparent"> OWE ME</span>
                    </h1>
                    </div>
                    {/* <!-- End Title --> */}

                    <div className="mt-5 max-w-3xl text-center mx-auto">
                    <p className="text-lg text-gray-600 dark:text-gray-400">Louis XIII, and it's all on me, nigga, you just bought a shot
                        Kamikaze, if you think that you gon' knock me off the top<br />Shit, your wife in the backseat of my brand new foreign car Don't act like you forgot<br />I call the shots, shots, shots Like bra, bra, bra
                        <br />Pay me what you owe me, don't act like you forgot
                    </p>
                    </div>
                    ...
                    <span className="text-sm font-bold text-gray-900 dark:text-white">dez nutz</span>
